...
class TakeAppointmentView(CreateView):
    template_name = 'appointment1/take_appointment.html'
...
class AppointmentCreateView(CreateView):
    template_name = 'appointment1/appointment_create.html'
...
class AppointmentListView(ListView):
    model = Appointment
    template_name = 'appointment1/appointment.html'
...
class PatientListView(ListView):
    ...
    template_name = "appointment1/patient_list.html"
...
class ServiceView(TemplateView):
    template_name = 'appointment1/service.html'


class SearchView(ListView):
    paginate_by = 6
    model = Appointment
    template_name = 'appointment1/search.html'
    context_object_name = 'appointment'
