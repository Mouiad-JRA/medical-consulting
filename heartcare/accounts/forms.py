...
class PatientRegistrationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['medical_history'].label = "medical_history"
        self.fields['consultation_text'].label = "consultation_text"
...
class PatientProfileUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['consultation_text'].widget.attrs.update(
            {
                'placeholder': 'consultation text',
            }
        )

    class Meta:
        model = User
        fields = ["first_name", "last_name", "email","age", "medical_history" ,"consultation_text", "phone_number"]
